const StatisticsMoneyCard = ({cardTitle, cardData}) => {
  return ( 
    <div className="statistics-card">
      ...
      <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="statistics-svg"xmlns="http://www.w3.org/2000/svg">
...
export default StatisticsMoneyCard;