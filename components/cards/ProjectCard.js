      ...
      <div className="container flex justify-center">
        <div className="max-w-sm ">
          <div className=" relative shadow-lg shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 rounded-lg">
            ...
            <div className="py-6 px-8 rounded-lg bg-yellow-200">
            ...
            {projectTitle}
              ...
              <button className="button-basic">View Project</button>
            </div>
            <div className="absolute -top-2 -right-2 py-2 px-4 bg-yellow-400 rounded-lg">
